...
fun RegisterInitialScreen(
    ...
    uiStateFlow: StateFlow<RegisterUserInfoState>,
    onNavigateToLogin: () -> Unit,
    isProgressBarShow: Boolean,
) {
    val uiState: RegisterUserInfoState = uiStateFlow.collectAsState().value
    ...
    Box(
        ...
        Column(
            ...
            AuthBtnComponent(
                ...
                isProgressBarShow = isProgressBarShow
            )
...
fun RegisterScreenPreview() {
    MaterialTheme {
        RegisterInitialScreen(
            onInteraction = {},
            uiStateFlow = MutableStateFlow(RegisterUserInfoState()),
            onNavigateToLogin = { },
            isProgressBarShow = true
        )
    }
